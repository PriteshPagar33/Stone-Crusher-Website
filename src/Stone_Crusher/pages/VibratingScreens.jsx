...
import img1 from '../assets/vibratingscreen.png'
import img2 from '../assets/vibratingscreen2.png'
...
function VibratingScreens() {
  const VibratingScreens={
  ...
  return (
    <>
      <Machine MachineName={VibratingScreens.Name} MachineDescription={VibratingScreens.description} Machineimg={VibratingScreens.img1} Machineimg2={img2} MachineTitles={VibratingScreens.title} carousel={VibratingScreens.carouselimages} advantages={VibratingScreens.advantages}/>
    </>
   )
}

export default VibratingScreens