...
import img1 from '../assets/jawcrusher.png'
import img2 from '../assets/jawcrusher2.png'
...
function Jawcrusher() {
  ...
  return (
    <>
      <Machine MachineName={Jawcrusher.Name} MachineDescription={Jawcrusher.description} Machineimg={Jawcrusher.img1} Machineimg2={Jawcrusher.img2} MachineTitles={Jawcrusher.title} MachineApplication={Jawcrusher.Application} carousel={Jawcrusher.carouselimages} advantages={Jawcrusher.advantages}/>
    </>
   )
}
