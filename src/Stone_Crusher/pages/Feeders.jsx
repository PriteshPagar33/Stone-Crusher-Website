...
import img1 from '../assets/Feeder.png'
import img2 from '../assets/feeder1.png'
...
function Feeder() {
  ...
  return (
    <>
      <Machine MachineName={Feeder.Name} MachineDescription={Feeder.description} Machineimg={Feeder.img1} Machineimg2={img2} MachineTitles={Feeder.title}  carousel={Feeder.carouselimages} advantages={Feeder.advantages}/>
    </>
   )
}
